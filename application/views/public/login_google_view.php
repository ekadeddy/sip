		...
		<div class="col-lg-6 " >
			<div class="login-box ">
				...
				<div class="login-box-body ">
					...
					<div class="row">
						<div class="col-xs-12">
                                                     <a href="<?=base_url('google/home')?>" class="btn bg-teal btn-block btn-flat">login with Google Account</a>
						</div>
<!--						 /.col 
						<div class="col-xs-4">
					...
					<!-- /.social-auth-links -->
						...
						<!-- /.col -->
						<div class="col-xs-4">
<!--                                                    <a href="<?=base_url('google/home')?>" class="btn btn-danger">login with Google Account</a>-->
<!--                                                    <a href="<?= $login_google ?>" class="btn btn-danger">Login Google</a>-->
						</div>
						<!-- /.col -->
					</div>
